 ...
 <ul class="nav pull-right">
		...
		<li class="dropdown">
		  ...
		  <ul class="dropdown-menu">
		     <li><a href="http://www.minws.com/guide">新手向导</a></li>
		     <li class="divider"></li>
		     <li><a href="http://www.minws.com/support" >商业支持</a></li>
		     <li class="divider"></li>
		 	 <li><a href="http://www.minws.com/" >官方网站</a></li>
		  </ul>
		</li>
		<li class="dropdown">
